...
function TestCard({
    ...
    return (
        <>
            <section className="relative z-20 overflow-hidden pb-12 lg:pb-[90px] lg:pt-[50px]">
                <div className="container mx-auto">
                    <div className=" lg:w-3/4 mx-auto border border-gray-300 rounded-md cursor-pointer shadow-lg" onClick={navigateToServiceDescription}>
                        <div className="h-full  bg-opacity-75 px-8 pt-8 pb-16 rounded-lg overflow-hidden text-center relative">
                            ...
                            <div className="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4">
                                <button className='border bg-indigo-500 p-2 rounded-md text-white'>Book Appointment</button>
                            </div>
                        </div>
                    </div>
                </div>
