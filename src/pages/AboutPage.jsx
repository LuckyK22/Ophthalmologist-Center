            ...
            <section className="body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-full mx-auto flex flex-wrap items-center">
                        <img alt="ecommerce" className="lg:w-1/4 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/400x400" />
            ...
            <section className="text-white  body-font">
                <div className="container px-5 py-8 mx-auto ">
                    <div className="flex flex-wrap -m-4 gap-16 justify-center">
                        <div className=" lg:w-1/4 border rounded-md">
                            <div className="h-full bg-opacity-75 pt-8 pb-8 rounded-lg overflow-hidden text-center relative">
                                ...
                                <h1 className="title-font sm:text-2xl text-xl font-medium  mb-3 mt-4">Our Vision</h1>
                        ...
                        <div className=" lg:w-1/4 border rounded-md">
                            <div className="h-full bg-opacity-75 pt-8 pb-8 rounded-lg overflow-hidden text-center relative">
                                ...
                                <h1 className="title-font sm:text-2xl text-xl font-medium  mb-3 mt-4">Our Mission</h1>
                        ...
                        <div className=" lg:w-1/4 border rounded-md">
                            <div className="h-full bg-opacity-75 pt-8 pb-8 rounded-lg overflow-hidden text-center relative">
                                ...
                                <h1 className="title-font sm:text-2xl text-xl font-medium  mb-3 mt-4">Our Value</h1>
